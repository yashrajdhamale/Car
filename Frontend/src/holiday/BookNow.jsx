...
const BookNow = () => {
    ...
    const [selectedLocationID, setSelectedLocationID] = useState(value);
    ...
    // useEffect(() => {
    //     console.log("setSelectedLocation = " + selectedLocationID);
    //     const fetchLocationDataByID = async () => {
    //         try {
    //             let data = []
    //             const q = query(collection(db, "test"), where("location", "==", selectedLocationID));
    ...
    // console.log("25, setSelectedLocationID", selectedLocationID);
    ...
    return (
        <div>
            ...
            <h1 className="text-2xl font-bold text-left ml-4 m-10 lg:m-5 lg:text-4xl">
                {/* Rooftop Patio with Jacuzzi @ Koregaon Park-Pune */}
                Munnar with Alleppey - Kumarakom 4 Nights 5 Days
            </h1>
                ...
                {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="rounded-md border">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-3 justify-start text-sm text-gray-600">

                                <div className="mt-4 space-y-2">
                                    <ul className="list-disc pl-4 text-sm">
                                        <li>
                                            In the Afternoon, Arrive at Kochi Airport and then transfers to Munnar
                                        </li>

                                        <li>
                                            Later check into hotel. Visit to to local sightseeing.
                                        </li>

                                        <li>
                                            Rest of the day at own leisure. Overnight stay in Munnar.
                                        </li>
            ...
            <div className="mx-auto max-w-7xl px-4">
                ...
                <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
                    ...
                    <p className="text-center text-3xl font-bold text-white md:text-5xl md:leading-10">
                        Love to hear from you
                    </p>
                    <p className="mx-auto max-w-4xl text-center text-base text-white md:text-xl">
