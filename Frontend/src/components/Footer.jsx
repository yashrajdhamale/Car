...
//                                     <Car/>
//                                     <span className="ml-4 text-lg font-bold">Travelog</span>
//                                 </div>
//                                 <div>
//                                     <p className="mb-4  text-base font-medium">Travelog Your Travel Partner</p>
//                                     <p className="text-sm text-gray-600">
//                                         &copy; Copyright 2022. All Rights Reserved by Travelog.
//                                     </p>
//                                 </div>
//                             </div>
//                         </div>
...
const Footer = () => {
  ...
  return (
    <>
      {/* This wrapper ensures spacing above footer */}
      <div className="mt-12"></div> {/* 👈 adds gap above footer */}
      ...
      <footer className="w-full bg-white border-t border-gray-200 mt-auto">
        {!isMobile ? (
              ...
              <div className="-m-6 flex flex-wrap">
                <div className="w-full p-6 md:w-1/2 lg:w-5/12">
                  <div className="flex h-full flex-col justify-between">
                    ...
                    <div>
                      <p className="mb-4 text-base font-medium">Travelog — Your Travel Partner</p>
                      <p className="text-sm text-gray-600">
                        &copy; 2022 Travelog. All Rights Reserved.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                  <div className="h-full">
                    ...
                    <ul className="space-y-2">
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Features</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Pricing</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Affiliate</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Press Kit</a></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                  <div className="h-full">
                    ...
                    <ul className="space-y-2">
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Account</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Help</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Contact Us</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Customer Support</a></li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="w-full p-6 md:w-1/2 lg:w-3/12">
                  <div className="h-full">
                    ...
                    <ul className="space-y-2">
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Terms &amp; Conditions</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Privacy Policy</a></li>
                      <li><a href="#" className="text-base text-gray-700 hover:text-black">Licensing</a></li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <section className="overflow-hidden py-8 border-t border-gray-200">
            <div className="container mx-auto px-4">
              <div className="flex flex-col items-center space-y-6">
                <div className="flex items-center">
                  <Car />
                  <span className="ml-3 text-lg font-bold">Travelog</span>
                </div>
                ...
                <p className="text-sm text-gray-500 text-center">
                  © 2022 Travelog. All Rights Reserved.
                </p>
              </div>
            </div>
          </section>
