...
//   const [selectedRate, setSelectedRate] = useState({ row: null, col: null });
...
//   const isBookActive = (rowIdx) =>
//     selectedRate.row === rowIdx && selectedRate.col !== null;
...
//                     </th>
//                   ))}
//                   <th className="px-3 py-3.5 text-center text-white font-semibold text-sm border-r border-white/20 whitespace-nowrap">
//                     Guests
//                   </th>
...
//                       const isSelected = selectedRate.row === i && selectedRate.col === vIdx;
//                       const rateObj = pkg.rates?.find((r) => r.vehicle === (veh.name || veh));
//                       return (
//                         <td
//                           key={vIdx}
//                           onClick={() => { if (rateObj) setSelectedRate({ row: i, col: vIdx }); }}
//                           className="px-3 py-4 text-center align-middle transition-colors"
//                           style={{
//                             borderRight: "1px solid #fde8d0",
//                             cursor: rateObj ? "pointer" : "default",
//                             background: isSelected
//                               ? "linear-gradient(135deg, #fff7ed, #ffedd5)"
//                               : undefined,
//                             boxShadow: isSelected ? "inset 0 0 0 1.5px #f97316" : undefined,
//                           }}
//                         >
//                           {rateObj ? (
//                             <span
...
//                       <button
//                         disabled={!isBookActive(i)}
//                         onClick={() => {
//                           if (!isBookActive(i)) return;
//                           const selectedVehicle = vehicles[selectedRate.col];
//                           const vehicleCapacity = selectedVehicle.capacity || 4;
//                           const guests = guestCounts[i] || 1;
//                           if (guests > vehicleCapacity) {
//                             alert(`${selectedVehicle.name} fits max ${vehicleCapacity} guests.`);
//                             return;
//                           }
//                           if (!loggedIn) {
...
//                                 guests,
//                                 price: pkg.rates[selectedRate.col].price,
//                               },
//                             });
//                           }
//                         }}
//                         className={`text-sm px-5 py-1.5 rounded-lg font-semibold transition-all whitespace-nowrap ${
//                           isBookActive(i)
//                             ? "bg-orange-500 hover:bg-orange-600 text-white shadow-sm hover:shadow-md"
//                             : "bg-gray-100 text-gray-400 cursor-not-allowed"
//                         }`}
//                       >
//                         {isBookActive(i) ? "Book Now" : "Select"}
//                       </button>
//                     </td>
//                   </tr>
//                 ))}
...
//             Select a vehicle to activate booking · Prices are per trip inclusive of driver
//           </p>
//         </div>
//       </div>
